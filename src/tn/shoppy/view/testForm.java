 ...
 * @author DevSpark
 */
public class testForm extends SideMenuBaseForm {

    protected Resources res;

    public testForm(Resources res) {
        ...
        menuButton.addActionListener(e -> PointsService.getInstance().afficherPoints());
        ...
        Label title = new Label("Produits récents");
